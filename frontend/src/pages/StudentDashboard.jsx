                                                ...
                                                {myLostPosts.map(item => (
                                                    ...
                                                    >
                                                        <div className="h-32 bg-gray-100 relative">
                                                            {item.images?.[0]
                                                                ? <img src={`${API.defaults.baseURL.replace('/api', '')}${item.images[0]}`} alt="" className="w-full h-full object-cover" />
                                                        ...
                                                        <div key={claim._id} 
                                                            ...
                                                            <div className="flex items-start justify-between gap-3">
                                                                <div className="flex items-center gap-3">
                                                                    {claim.item?.images?.[0]
                                                                        ? <img src={`${API.defaults.baseURL.replace('/api', '')}${claim.item.images[0]}`} alt="" className="w-14 h-14 rounded-xl object-cover border border-gray-100" />
